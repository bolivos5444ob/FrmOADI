...
module.exports = {
	...
	plugins: [
		require('./resources/metronic/src/core/plugins/plugin'),
		require('./resources/metronic/src/core/plugins/components/theme'),
		require('./resources/metronic/src/core/plugins/components/breakpoints'),
		require('./resources/metronic/src/core/plugins/components/typography'),
		require('./resources/metronic/src/core/plugins/components/menu'),
		require('./resources/metronic/src/core/plugins/components/dropdown'),
		require('./resources/metronic/src/core/plugins/components/accordion'),
		require('./resources/metronic/src/core/plugins/components/input'),
		require('./resources/metronic/src/core/plugins/components/input-group'),
		require('./resources/metronic/src/core/plugins/components/select'),
		require('./resources/metronic/src/core/plugins/components/textarea'),
		require('./resources/metronic/src/core/plugins/components/file-input'),
		require('./resources/metronic/src/core/plugins/components/switch'),
		require('./resources/metronic/src/core/plugins/components/checkbox'),
		require('./resources/metronic/src/core/plugins/components/radio'),
		require('./resources/metronic/src/core/plugins/components/range'),
		require('./resources/metronic/src/core/plugins/components/container'),
		require('./resources/metronic/src/core/plugins/components/image-input'),
		require('./resources/metronic/src/core/plugins/components/modal'),
		require('./resources/metronic/src/core/plugins/components/drawer'),
		require('./resources/metronic/src/core/plugins/components/tooltip'),
		require('./resources/metronic/src/core/plugins/components/popover'),
		require('./resources/metronic/src/core/plugins/components/btn'),
		require('./resources/metronic/src/core/plugins/components/btn-group'),
		require('./resources/metronic/src/core/plugins/components/tabs'),
		require('./resources/metronic/src/core/plugins/components/pagination'),
		require('./resources/metronic/src/core/plugins/components/card'),
		require('./resources/metronic/src/core/plugins/components/table'),
		require('./resources/metronic/src/core/plugins/components/badge'),
		require('./resources/metronic/src/core/plugins/components/rating'),
		require('./resources/metronic/src/core/plugins/components/scrollable'),
		require('./resources/metronic/src/core/plugins/components/progress'),
		require('./resources/metronic/src/core/plugins/components/apexcharts'),
		require('./resources/metronic/src/core/plugins/components/leaflet'),
	  ],
};
